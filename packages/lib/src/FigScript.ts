...
function add(a: any, b: any): any {
  if (!b || !a) throw new TypeError(`add() cannot be applied to null`)
...
function sub(a: any, b: any): any {
  if (!b || !a) throw new TypeError(`sub() cannot be applied to null`)
  return vector.is(a) && (vector.is(b) || typeof b == 'number')
    ? vector.sub(a, b)
    : a - b
}
function mult<T>(a: T, b: any): T
function mult<V extends vector.Vec>(a: V, b: number): V
function mult(a: any, b: any): any {
  if (!b || !a) throw new TypeError(`mult() cannot be applied to null`)
  return vector.is(a) && typeof b == 'number' ? vector.mult(a, b) : a * b
}
function div<T>(a: T, b: any): T
function div<V extends vector.Vec>(a: V, b: number): V
function div(a: any, b: any): any {
  if (!b || !a) throw new TypeError(`div() cannot be applied to null`)
  return vector.is(a) && typeof b == 'number' ? vector.div(a, b) : a / b
}
